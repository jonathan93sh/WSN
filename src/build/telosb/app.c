...
#line 42
button_state_t;
# 4 "/home/tinyos/WSN/src/src/discoprimepairlut.h"
uint16_t lutDC[150] = { 8316, 8423, 8458, 8498, 8533, 8571, 8753, 8832, 8869, 8870, 8904, 9124, 9295, 9344, 9346, 9363, 9421, 9642, 9854, 9896, 9929, 9950, 10076, 10113, 10122, 10160, 10180, 10231, 10299, 10492, 10573, 10739, 10793, 10983, 11129, 11138, 11192, 11335, 11541, 11626, 11665, 11823, 11858, 11859, 12113, 12172, 12199, 12261, 12319, 12453, 12717, 12775, 12933, 13038, 13244, 13370, 13518, 13722, 13769, 14206, 14294, 14441, 14533, 14773, 14877, 15012, 15447, 15656, 15736, 15824, 16207, 16303, 16407, 16546, 16577, 16654, 16908, 17128, 17146, 17459, 17506, 17697, 17864, 17943, 18102, 18434, 18472, 18663, 18794, 19068, 19389, 19559, 19918, 19986, 20108, 20477, 20791, 21026, 21112, 21396, 21640, 21886, 22233, 22244, 22434, 22747, 22837, 22916, 23149, 23464, 23657, 23752, 24554, 25081, 25162, 25582, 25994, 26183, 26794, 27084, 27395, 27995, 28244, 29393, 29868, 30247, 30795, 31074, 31622, 32308, 32687, 33065, 33512, 34684, 34952, 35061, 35497, 35884, 37321, 37834, 37865, 38952, 39268, 39743, 40926, 41685, 42798, 44038, 45148, 47079 };
uint8_t lutPrime1[150] = { 239, 233, 233, 229, 229, 227, 227, 223, 211, 223, 211, 211, 199, 193, 197, 191, 197, 193, 179, 193, 179, 191, 197, 167, 173, 173, 193, 193, 179, 173, 181, 179, 179, 167, 163, 167, 167, 173, 167, 163, 151, 151, 149, 157, 157, 151, 149, 149, 157, 149, 151, 131, 139, 149, 137, 131, 139, 131, 139, 131, 131, 137, 127, 131, 131, 127, 127, 107, 109, 109, 101, 109, 109, 101, 107, 113, 107, 101, 107, 101, 103, 101, 97, 109, 97, 107, 103, 101, 103, 97, 97, 97, 97, 89, 97, 89, 83, 89, 83, 79, 83, 79, 83, 79, 79, 73, 79, 73, 83, 73, 71, 79, 79, 67, 71, 73, 67, 73, 67, 59, 67, 59, 61, 59, 61, 61, 59, 61, 59, 53, 53, 59, 53, 47, 53, 47, 53, 47, 47, 43, 47, 41, 43, 47, 41, 43, 41, 43, 41, 41 };
uint8_t lutPrime2[150] = { 241, 241, 239, 241, 239, 239, 229, 229, 241, 227, 239, 227, 233, 239, 233, 241, 229, 223, 233, 211, 229, 211, 199, 241, 229, 227, 199, 197, 211, 211, 197, 193, 191, 199, 199, 193, 191, 179, 179, 181, 197, 191, 193, 181, 173, 179, 181, 179, 167, 173, 163, 193, 173, 157, 167, 173, 157, 163, 151, 151, 149, 139, 149, 139, 137, 139, 131, 157, 151, 149, 157, 139, 137, 149, 137, 127, 131, 137, 127, 131, 127, 127, 131, 113, 127, 109, 113, 113, 109, 113, 109, 107, 103, 113, 101, 107, 113, 101, 109, 113, 103, 107, 97, 103, 101, 109, 97, 107, 89, 101, 103, 89, 83, 97, 89, 83, 89, 79, 83, 97, 79, 89, 83, 79, 73, 71, 71, 67, 67, 73, 71, 61, 67, 73, 61, 71, 59, 67, 61, 67, 59, 67, 61, 53, 59, 53, 53, 47, 47, 43 };
# 4 "/home/tinyos/WSN/src/src/Disco.h"
...
typedef nx_struct DiscoMsg {
  ...
  nx_uint16_t prime2;
  nx_uint8_t type;
  nx_uint8_t payload_len;
  nx_uint8_t checksum;
} __attribute__((packed)) DiscoMsg;

static uint8_t calcCheckSumMsg(DiscoMsg *this);
#line 55
static void createDiscoMsg(DiscoMsg *this, uint16_t nodeid, uint16_t counter, uint16_t timeslot, uint16_t prime1, uint16_t prime2, uint8_t type, uint8_t payload_len);
#line 67
static uint8_t calcCheckSumMsg(DiscoMsg *this);
...
static inline error_t getDiscoMsg(void *payload, DiscoMsg **msgPtr, void **msgPayload, uint8_t len, uint8_t *payloadlen);
...
# 4 "/home/tinyos/WSN/src/src/testmaster.h"
...
typedef TMilli testmasterC__Timer0__precision_tag;
typedef button_state_t testmasterC__Notify__val_t;
typedef button_state_t testmasterC__Get__val_t;
typedef TMilli testmasterC__Counter0__precision_tag;
typedef uint32_t testmasterC__Counter0__size_type;
typedef TMilli DiscoC__Timer0__precision_tag;
typedef TMilli DiscoC__Timer2_retransmit__precision_tag;
typedef TMilli DiscoC__Timer1__precision_tag;
...
static void testmasterC__Timer0__fired(void );
# 49 "/opt/tinyos-2.1.1/tos/interfaces/Boot.nc"
static void testmasterC__Boot__booted(void );
# 74 "/opt/tinyos-2.1.1/tos/interfaces/Notify.nc"
static void testmasterC__Notify__notify(testmasterC__Notify__val_t val);
# 71 "/opt/tinyos-2.1.1/tos/lib/timer/Counter.nc"
static void testmasterC__Counter0__overflow(void );
# 24 "/home/tinyos/WSN/src/src/Disco.nc"
static void testmasterC__Disco__received(DiscoMsg *msg, void *buf, uint8_t len);
#line 23
static error_t testmasterC__Disco__fetchPayload(DiscoMsg *msg, void *buf, uint8_t *len);
# 72 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
static void DiscoC__Timer0__fired(void );
#line 72
static void DiscoC__Timer2_retransmit__fired(void );
# 92 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static void DiscoC__AMControl__startDone(error_t error);
#line 117
static void DiscoC__AMControl__stopDone(error_t error);
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void DiscoC__AMSend__sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 72 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
static void DiscoC__Timer1__fired(void );
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
static 
#line 63
message_t * 
...
uint8_t len);
# 18 "/home/tinyos/WSN/src/src/Disco.nc"
static error_t DiscoC__Disco__setBeaconMode(bool beacon);
#line 11
static void DiscoC__Disco__getPrimePair(uint16_t *p1, uint16_t *p2);


static error_t DiscoC__Disco__setNodeClass(uint16_t classid);
#line 7
static float DiscoC__Disco__setDutyCycleIndex(uint16_t dutycycleIdx, uint32_t shift);
# 34 "/opt/tinyos-2.1.1/tos/chips/msp430/timer/Msp430Compare.nc"
...
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t /*testmasterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
static void /*testmasterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(
#line 85
message_t * msg, 
...
# 62 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
static void testmasterC__Timer0__startOneShot(uint32_t dt);
# 59 "/opt/tinyos-2.1.1/tos/interfaces/Notify.nc"
static error_t testmasterC__Notify__enable(void );
# 50 "/opt/tinyos-2.1.1/tos/interfaces/Leds.nc"
static void testmasterC__Leds__led0Off(void );





static void testmasterC__Leds__led0Toggle(void );




static void testmasterC__Leds__led1On(void );




static void testmasterC__Leds__led1Off(void );
#line 83
static void testmasterC__Leds__led2Off(void );
#line 78
static void testmasterC__Leds__led2On(void );
# 53 "/opt/tinyos-2.1.1/tos/lib/timer/Counter.nc"
static testmasterC__Counter0__size_type testmasterC__Counter0__get(void );
# 18 "/home/tinyos/WSN/src/src/Disco.nc"
static error_t testmasterC__Disco__setBeaconMode(bool beacon);
#line 11
static void testmasterC__Disco__getPrimePair(uint16_t *p1, uint16_t *p2);


static error_t testmasterC__Disco__setNodeClass(uint16_t classid);
#line 7
static float testmasterC__Disco__setDutyCycleIndex(uint16_t dutycycleIdx, uint32_t shift);
# 25 "/home/tinyos/WSN/src/src/testmasterC.nc"
uint32_t testmasterC__testN = 10;
uint32_t testmasterC__lastDisco = 0;
uint32_t testmasterC__counter_reset_value = 30;
uint32_t testmasterC__countdown = 0;
uint16_t testmasterC__ButtonPressCounter = 0;

uint32_t testmasterC__test_cur = 0;

uint16_t testmasterC__MprimeIDX[10] = { 149, 100, 100, 50, 50, 50, 125, 100, 25, 25 };
uint16_t testmasterC__SprimeIDX[10] = { 149, 148, 100, 146, 100, 50, 125, 125, 25, 149 };
...
static void DiscoC__Timer2_retransmit__startOneShot(uint32_t dt);




static void DiscoC__Timer2_retransmit__stop(void );
# 83 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static error_t DiscoC__AMControl__start(void );
#line 109
static error_t DiscoC__AMControl__stop(void );
# 115 "/opt/tinyos-2.1.1/tos/interfaces/Packet.nc"
static 
#line 112
void * 
...
uint8_t len);
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t DiscoC__AMSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 62 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
static void DiscoC__Timer1__startOneShot(uint32_t dt);




static void DiscoC__Timer1__stop(void );
# 24 "/home/tinyos/WSN/src/src/Disco.nc"
static void DiscoC__Disco__received(DiscoMsg *msg, void *buf, uint8_t len);
#line 23
static error_t DiscoC__Disco__fetchPayload(DiscoMsg *msg, void *buf, uint8_t *len);
# 22 "/home/tinyos/WSN/src/src/DiscoC.nc"
message_t DiscoC__pkt;
uint16_t DiscoC__prime1;
#line 23
uint16_t DiscoC__prime2;
uint32_t DiscoC__counter = 0;
float DiscoC__DC = 0;
uint16_t DiscoC__ID = 0;
uint16_t DiscoC__timeout = 0;
bool DiscoC__beaconEn = FALSE;
bool DiscoC__busy = FALSE;
uint16_t DiscoC__connectNodeID = -1;
nx_uint8_t DiscoC__packetBuffer[100];
size_t DiscoC__PacketSize = 0;
uint8_t DiscoC__retry_counter = 0;


static void DiscoC__transmit_done(void );
static void DiscoC__transmit(void );
static inline void DiscoC__transmitPacket(void *payload, uint8_t len);
static void DiscoC__transmitBeacon(void );

static inline void DiscoC__transmitACK(void );
#line 57
static float DiscoC__Disco__setDutyCycleIndex(uint16_t dutycycleIdx, uint32_t shift);
...
static inline void DiscoC__Disco__getPrimePair(uint16_t *p1, uint16_t *p2);
...
static inline error_t DiscoC__Disco__setNodeClass(uint16_t classid);
...
static inline error_t DiscoC__Disco__setBeaconMode(bool beacon);
#line 104
bool DiscoC__eop = FALSE;

static inline void DiscoC__Timer0__fired(void );
#line 137
static inline void DiscoC__Timer1__fired(void );



static inline void DiscoC__AMSend__sendDone(message_t *msg, error_t error);



static inline void DiscoC__AMControl__startDone(error_t error);




static inline void DiscoC__AMControl__stopDone(error_t error);



static inline message_t *DiscoC__Receive__receive(message_t *msg, void *payload, uint8_t len);
#line 216
static inline void DiscoC__Timer2_retransmit__fired(void );
...
enum /*Counter32khz32C.Transform*/TransformCounterC__1____nesc_unnamed4356 {
...
enum /*AlarmMultiplexC.Alarm.Alarm32khz32C.Transform*/TransformAlarmC__1____nesc_unnamed4357 {
...
message_t *msg);
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void /*testmasterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
static error_t /*testmasterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(
#line 56
message_t * msg, 
...
uint8_t len);
# 92 "/opt/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
static void /*testmasterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*testmasterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(
#line 147
message_t * amsg, 
...
am_id_t t);
# 45 "/opt/tinyos-2.1.1/tos/system/AMQueueEntryP.nc"
static inline error_t /*testmasterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*testmasterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(message_t *m, error_t err);
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
...
#line 49
#line 47
typedef struct /*AMQueueP.AMQueueImplP*/AMQueueImplP__1____nesc_unnamed4382 {
  message_t * msg;
...
enum /*UserButtonC.SwitchToggleC*/SwitchToggleC__0____nesc_unnamed4383 {
#line 51
...
# 28 "/opt/tinyos-2.1.1/tos/chips/msp430/timer/Msp430TimerEvent.nc"
inline static void /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__fired(uint8_t arg_0x4065d4b0){
#line 28
  switch (arg_0x4065d4b0) {
#line 28
    case 0:
#line 28
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__default__fired(arg_0x4065d4b0);
#line 28
      break;
#line 28
    }
...
#line 71
  testmasterC__Counter0__overflow();
#line 71
}
#line 71
...
# 55 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__unconfigure(uint8_t arg_0x40aeecf8){
#line 55
  switch (arg_0x40aeecf8) {
#line 55
...
#line 55
    default:
#line 55
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__unconfigure(arg_0x40aeecf8);
#line 55
      break;
#line 55
    }
...
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__release(uint8_t arg_0x40f79388){
#line 110
  unsigned char __nesc_result;
#line 110

#line 110
  switch (arg_0x40f79388) {
#line 110
...
#line 110
    default:
#line 110
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__release(arg_0x40f79388);
#line 110
      break;
#line 110
    }
...
# 88 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCongestionBackoff(am_id_t arg_0x41289df8, message_t * msg){
#line 88
    CC2420ActiveMessageP__RadioBackoff__default__requestCongestionBackoff(arg_0x41289df8, msg);
#line 88
}
#line 88
...
# 118 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__isOwner(uint8_t arg_0x40f79388){
#line 118
  unsigned char __nesc_result;
#line 118
...
#line 118
    default:
#line 118
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__isOwner(arg_0x40f79388);
#line 118
      break;
#line 118
    }
...
# 39 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__getConfig(uint8_t arg_0x40f79dd8){
#line 39
  union __nesc_unnamed4284 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__default__getConfig(arg_0x40f79dd8);
#line 39
...
# 49 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__configure(uint8_t arg_0x40aeecf8){
#line 49
  switch (arg_0x40aeecf8) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__configure(arg_0x40aeecf8);
#line 49
      break;
#line 49
    }
...
# 51 "/opt/tinyos-2.1.1/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__immediateRequested(uint8_t arg_0x40aef948){
#line 51
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__default__immediateRequested(arg_0x40aef948);
#line 51
}
#line 51
...
# 87 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__immediateRequest(uint8_t arg_0x40f79388){
#line 87
  unsigned char __nesc_result;
#line 87
...
#line 87
    default:
#line 87
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__immediateRequest(arg_0x40f79388);
#line 87
      break;
#line 87
    }
...
# 43 "/opt/tinyos-2.1.1/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__requested(uint8_t arg_0x40aef948){
#line 43
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__default__requested(arg_0x40aef948);
#line 43
}
#line 43
...
# 78 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__request(uint8_t arg_0x40f79388){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__request(arg_0x40f79388);
#line 78
      break;
#line 78
    }
...
#line 74
  testmasterC__Notify__notify(val);
#line 74
}
#line 74
...
# 53 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void DiscoC__Timer0__startPeriodic(uint32_t dt){
#line 53
...
#line 31
# 141 "/home/tinyos/WSN/src/src/DiscoC.nc"
static inline void DiscoC__AMSend__sendDone(message_t *msg, error_t error)
#line 141
{
  DiscoC__busy = FALSE;
...
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void /*testmasterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(message_t * msg, error_t error){
#line 99
  DiscoC__AMSend__sendDone(msg, error);
#line 99
}
#line 99
...
#line 57
{
  /*testmasterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(m, err);
}
...
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__Send__sendDone(uint8_t arg_0x40b44e48, message_t * msg, error_t error){
#line 89
  switch (arg_0x40b44e48) {
#line 89
    case 0U:
#line 89
      /*testmasterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(msg, error);
#line 89
      break;
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__Send__default__sendDone(arg_0x40b44e48, msg, error);
#line 89
      break;
#line 89
    }
...
#line 56
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__send(am_id_t arg_0x40b41908, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = CC2420ActiveMessageP__AMSend__send(arg_0x40b41908, addr, msg, len);
#line 69
...
# 59 "/opt/tinyos-2.1.1/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP__SendNotifier__aboutToSend(am_id_t arg_0x41289780, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP__SendNotifier__default__aboutToSend(arg_0x41289780, dest, msg);
#line 59
}
#line 59
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
...
# 95 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCca(am_id_t arg_0x41289df8, message_t * msg){
#line 95
    CC2420ActiveMessageP__RadioBackoff__default__requestCca(arg_0x41289df8, msg);
#line 95
}
#line 95
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void CC2420TinyosNetworkP__Resource__granted(uint8_t arg_0x4124fe68){
#line 92
  switch (arg_0x4124fe68) {
#line 92
...
#line 92
    default:
#line 92
      CC2420TinyosNetworkP__Resource__default__granted(arg_0x4124fe68);
#line 92
      break;
#line 92
    }
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Snoop__receive(am_id_t arg_0x4128cda0, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = CC2420ActiveMessageP__Snoop__default__receive(arg_0x4128cda0, msg, payload, len);
#line 67
...
# 115 "/opt/tinyos-2.1.1/tos/interfaces/Packet.nc"
inline static void * DiscoC__Packet__getPayload(message_t * msg, uint8_t len){
#line 115
  void *__nesc_result;
#line 115
...
#line 115
# 273 "/home/tinyos/WSN/src/src/DiscoC.nc"
static inline void DiscoC__transmitPacket(void *payload, uint8_t len)
{
  uint8_t *DiscoPacket;
  ...
  if (!DiscoC__busy) 
    {
      ...
      DiscoPacket = (uint8_t *)DiscoC__Packet__getPayload(&DiscoC__pkt, (uint8_t )sizeof(DiscoMsg ) + len);



      memcpy(DiscoPacket + sizeof(DiscoMsg ), payload, len);

      createDiscoMsg((DiscoMsg *)DiscoPacket, DiscoC__ID, DiscoC__counter, TSLOTms, DiscoC__prime1, DiscoC__prime2, T_PAYLOAD, len);

      DiscoC__PacketSize = sizeof(DiscoMsg ) + len;
      DiscoC__retry_counter = RETRYS;
      DiscoC__transmit();
    }
}
...
inline static void testmasterC__Leds__led0Toggle(void ){
#line 56
  LedsP__Leds__led0Toggle();
#line 56
}
#line 56
# 7 "/home/tinyos/WSN/src/src/Disco.nc"
inline static float testmasterC__Disco__setDutyCycleIndex(uint16_t dutycycleIdx, uint32_t shift){
#line 7
  float __nesc_result;
#line 7

#line 7
  __nesc_result = DiscoC__Disco__setDutyCycleIndex(dutycycleIdx, shift);
#line 7
...
inline static void testmasterC__Leds__led2On(void ){
#line 78
  LedsP__Leds__led2On();
#line 78
}
#line 78
# 68 "/home/tinyos/WSN/src/src/DiscoC.nc"
static inline void DiscoC__Disco__getPrimePair(uint16_t *p1, uint16_t *p2)
#line 68
{
  *p1 = DiscoC__prime1;
...
# 11 "/home/tinyos/WSN/src/src/Disco.nc"
inline static void testmasterC__Disco__getPrimePair(uint16_t *p1, uint16_t *p2){
#line 11
  DiscoC__Disco__getPrimePair(p1, p2);
#line 11
}
#line 11
# 53 "/opt/tinyos-2.1.1/tos/lib/timer/Counter.nc"
inline static testmasterC__Counter0__size_type testmasterC__Counter0__get(void ){
#line 53
  unsigned long __nesc_result;
#line 53
...
#line 53
# 48 "/home/tinyos/WSN/src/src/testmasterC.nc"
static inline error_t testmasterC__Disco__fetchPayload(DiscoMsg *msg, void *buf, uint8_t *len)
{
  uint16_t p1;
#line 50
  ...
  testMsg newMsg;
  uint32_t nowDisco = testmasterC__Counter0__get();
...
#line 54
  ...
  testmasterC__lastDisco = nowDisco;





  if (testmasterC__countdown == 0) 
    {
      testmasterC__countdown = testmasterC__counter_reset_value;
      testmasterC__test_cur++;
    }

  if (testmasterC__test_cur >= testmasterC__testN) {
    return FAIL;
    }

  if (testmasterC__test_cur == testmasterC__testN && testmasterC__countdown == 0) 
    {
      testmasterC__Leds__led2On();
      __nesc_hton_uint16(newMsg.next_prim_pair_idx.data, testmasterC__SprimeIDX[0]);
    }
  else 
    {
      testmasterC__Disco__setDutyCycleIndex(testmasterC__MprimeIDX[testmasterC__test_cur], rand());
      __nesc_hton_uint16(newMsg.next_prim_pair_idx.data, testmasterC__SprimeIDX[testmasterC__test_cur]);
    }

  memcpy(buf, &newMsg, sizeof(testMsg ));
  *len = sizeof(testMsg );

  testmasterC__Leds__led0Toggle();

  testmasterC__countdown--;
  return SUCCESS;
}

# 23 "/home/tinyos/WSN/src/src/Disco.nc"
inline static error_t DiscoC__Disco__fetchPayload(DiscoMsg *msg, void *buf, uint8_t *len){
#line 23
  unsigned char __nesc_result;
#line 23

#line 23
  __nesc_result = testmasterC__Disco__fetchPayload(msg, buf, len);
#line 23
...
# 24 "/home/tinyos/WSN/src/src/Disco.nc"
inline static void DiscoC__Disco__received(DiscoMsg *msg, void *buf, uint8_t len){
#line 24
  testmasterC__Disco__received(msg, buf, len);
#line 24
}
#line 24
# 312 "/home/tinyos/WSN/src/src/DiscoC.nc"
static inline void DiscoC__transmitACK(void )
{
  if (!DiscoC__busy) 
    {

      uint8_t *DiscoPacket = (uint8_t *)DiscoC__Packet__getPayload(&DiscoC__pkt, sizeof(DiscoMsg ));



      createDiscoMsg((DiscoMsg *)DiscoPacket, DiscoC__ID, DiscoC__counter, TSLOTms, DiscoC__prime1, DiscoC__prime2, T_ACK, 0);


      DiscoC__PacketSize = sizeof(DiscoMsg );
      DiscoC__retry_counter = 0;
      DiscoC__transmit();
    }
}

# 76 "/home/tinyos/WSN/src/src/Disco.h"
static inline error_t getDiscoMsg(void *payload, DiscoMsg **msgPtr, void **msgPayload, uint8_t len, uint8_t *payloadlen)
{
  DiscoMsg *dmHeader;
...
#line 104
  if (__nesc_ntoh_uint8(dmHeader->checksum.data) != calcCheckSumMsg(dmHeader)) 
    {
  ...
  if (__nesc_ntoh_uint8(dmHeader->payload_len.data) != len - sizeof(DiscoMsg )) 
    {
  ...
  if (__nesc_ntoh_uint8(dmHeader->type.data) == T_REQUEST && __nesc_ntoh_uint8(dmHeader->payload_len.data) != sizeof(uint16_t )) 
    {
  ...
  *msgPtr = dmHeader;
  ...
  if (__nesc_ntoh_uint8(dmHeader->payload_len.data) != 0) 
    {
      *msgPayload = (uint8_t *)payload + sizeof(DiscoMsg );
      *payloadlen = __nesc_ntoh_uint8(dmHeader->payload_len.data);
    }

  return SUCCESS;
}

# 154 "/home/tinyos/WSN/src/src/DiscoC.nc"
static inline message_t *DiscoC__Receive__receive(message_t *msg, void *payload, uint8_t len)
#line 154
{
  DiscoMsg *msgPtr;
  ...
  if (getDiscoMsg(payload, &msgPtr, &msgPayload, len, &payload_len) == SUCCESS) 
    {
      ...
      switch (__nesc_ntoh_uint8(msgPtr->type.data)) 
        {
          case T_ACK: 

            DiscoC__transmit_done();
          break;
          case T_BEACON: 
            DiscoC__transmit_done();
          DiscoC__connectNodeID = __nesc_ntoh_uint16(msgPtr->nodeid.data);
          DiscoC__Disco__received(msgPtr, 0, 0);

          break;
          case T_PAYLOAD: 
            DiscoC__transmit_done();
          DiscoC__transmitACK();
          DiscoC__Disco__received(msgPtr, msgPayload, payload_len);
          break;
          case T_REQUEST: 

            if (DiscoC__retry_counter != 0) 
              {
              }
            else {
              if ((msgPayload[0] << 8) | (msgPayload[1] == DiscoC__ID)) 
                {
                  DiscoC__transmit_done();

                  if (DiscoC__Disco__fetchPayload(msgPtr, DiscoC__packetBuffer, &Rlen) == SUCCESS) 
                    {

                      DiscoC__transmitPacket(DiscoC__packetBuffer, Rlen);
                    }
                }
              else 
                {
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Receive__receive(am_id_t arg_0x4128c708, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x4128c708) {
#line 67
    case 34:
#line 67
      __nesc_result = DiscoC__Receive__receive(msg, payload, len);
#line 67
      break;
#line 67
    default:
#line 67
      __nesc_result = CC2420ActiveMessageP__Receive__default__receive(arg_0x4128c708, msg, payload, len);
#line 67
      break;
#line 67
    }
...
inline static void DiscoC__Timer2_retransmit__stop(void ){
#line 67
...
#line 67
#line 62
inline static void DiscoC__Timer1__startOneShot(uint32_t dt){
#line 62
...
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static error_t /*testmasterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(message_t * msg, uint8_t len){
#line 64
  unsigned char __nesc_result;
#line 64
...
inline static void /*testmasterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(message_t * amsg, am_id_t t){
#line 151
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
inline static void /*testmasterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 92
...
#line 47
{
  /*testmasterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(msg, dest);
  /*testmasterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(msg, 34);
  return /*testmasterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(msg, len);
}

# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t DiscoC__AMSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = /*testmasterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(addr, msg, len);
#line 69
...
#line 69
# 62 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void DiscoC__Timer2_retransmit__startOneShot(uint32_t dt){
#line 62
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__granted(uint8_t arg_0x40f46648){
#line 92
  switch (arg_0x40f46648) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__default__granted(arg_0x40f46648);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__Resource__granted(uint8_t arg_0x40af2e78){
#line 92
  switch (arg_0x40af2e78) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__Resource__default__granted(arg_0x40af2e78);
#line 92
      break;
#line 92
    }
...
# 71 "/opt/tinyos-2.1.1/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__sendDone(uint8_t arg_0x40f7bb78, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 71
  switch (arg_0x40f7bb78) {
#line 71
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 71
...
#line 71
    default:
#line 71
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__default__sendDone(arg_0x40f7bb78, txBuf, rxBuf, len, error);
#line 71
      break;
#line 71
    }
...
# 71 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__readDone(uint8_t arg_0x40f01010, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0x40f01010) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP__Fifo__default__readDone(arg_0x40f01010, data, length, error);
#line 71
      break;
#line 71
    }
...
# 81 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestInitialBackoff(am_id_t arg_0x41289df8, message_t * msg){
#line 81
    CC2420ActiveMessageP__RadioBackoff__default__requestInitialBackoff(arg_0x41289df8, msg);
#line 81
}
#line 81
...
# 91 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__writeDone(uint8_t arg_0x40f01010, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0x40f01010) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP__Fifo__default__writeDone(arg_0x40f01010, data, length, error);
#line 91
      break;
#line 91
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void CC2420SpiP__Resource__granted(uint8_t arg_0x40f02558){
#line 92
  switch (arg_0x40f02558) {
#line 92
...
#line 92
    default:
#line 92
      CC2420SpiP__Resource__default__granted(arg_0x40f02558);
#line 92
      break;
#line 92
    }
...
#line 89
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP__AMSend__sendDone(am_id_t arg_0x4128fca0, message_t * msg, error_t error){
#line 99
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__sendDone(arg_0x4128fca0, msg, error);
#line 99
}
#line 99
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
...
#line 30
# 150 "/home/tinyos/WSN/src/src/DiscoC.nc"
static inline void DiscoC__AMControl__stopDone(error_t error)
#line 150
{
}
...
#line 117
  DiscoC__AMControl__stopDone(error);
#line 117
}
#line 117
...
# 145 "/home/tinyos/WSN/src/src/DiscoC.nc"
static inline void DiscoC__AMControl__startDone(error_t error)
#line 145
{
  if (error == SUCCESS) {
    DiscoC__transmitBeacon();
    }
}
...
#line 92
  DiscoC__AMControl__startDone(error);
#line 92
}
#line 92
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
...
inline static error_t DiscoC__AMControl__stop(void ){
#line 109
  unsigned char __nesc_result;
#line 109
...
# 83 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
inline static error_t DiscoC__AMControl__start(void ){
#line 83
  unsigned char __nesc_result;
#line 83
...
#line 83
# 67 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void DiscoC__Timer1__stop(void ){
#line 67
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__stop(1U);
#line 67
}
#line 67
# 106 "/home/tinyos/WSN/src/src/DiscoC.nc"
static inline void DiscoC__Timer0__fired(void )
#line 106
{
  ...
  if (!DiscoC__busy) 
    {
      if (DiscoC__counter % DiscoC__prime1 == 0 || DiscoC__counter % DiscoC__prime2 == 0) 
        {
          DiscoC__timeout = 0;
          DiscoC__Timer1__stop();

          DiscoC__AMControl__start();
          DiscoC__eop = FALSE;
        }
      else {
#line 118
        if ((DiscoC__counter - 1) % DiscoC__prime1 == 0 || (DiscoC__counter - 1) % DiscoC__prime2 == 0) 
          {
            if (DiscoC__beaconEn) 
              {
                DiscoC__transmitBeacon();
...
inline static void testmasterC__Leds__led1On(void ){
#line 61
  LedsP__Leds__led1On();
#line 61
}
#line 61
# 77 "/home/tinyos/WSN/src/src/DiscoC.nc"
static inline error_t DiscoC__Disco__setNodeClass(uint16_t classid)
#line 77
{
  DiscoC__ID = classid;
...
# 14 "/home/tinyos/WSN/src/src/Disco.nc"
inline static error_t testmasterC__Disco__setNodeClass(uint16_t classid){
#line 14
  unsigned char __nesc_result;
#line 14

#line 14
  __nesc_result = DiscoC__Disco__setNodeClass(classid);
#line 14
...
#line 14
# 86 "/home/tinyos/WSN/src/src/DiscoC.nc"
static inline error_t DiscoC__Disco__setBeaconMode(bool beacon)
#line 86
{
  DiscoC__beaconEn = beacon;
  return SUCCESS;
}

# 18 "/home/tinyos/WSN/src/src/Disco.nc"
inline static error_t testmasterC__Disco__setBeaconMode(bool beacon){
#line 18
  unsigned char __nesc_result;
#line 18

#line 18
  __nesc_result = DiscoC__Disco__setBeaconMode(beacon);
#line 18
...
inline static void testmasterC__Leds__led2Off(void ){
#line 83
...
# 50 "/opt/tinyos-2.1.1/tos/interfaces/Leds.nc"
inline static void testmasterC__Leds__led0Off(void ){
#line 50
...
#line 149
{
  ...
  testmasterC__countdown = testmasterC__counter_reset_value;
  testmasterC__Disco__setBeaconMode(TRUE);
  testmasterC__Disco__setNodeClass(TOS_NODE_ID);
  testmasterC__Disco__setDutyCycleIndex(testmasterC__MprimeIDX[0], rand());
  testmasterC__Leds__led1On();
  printf("countdown,testNr,p11,p12,p21,p22,disco(ms)\r\n");
  printfflush();
  testmasterC__lastDisco = testmasterC__Counter0__get();
}

# 216 "/home/tinyos/WSN/src/src/DiscoC.nc"
static inline void DiscoC__Timer2_retransmit__fired(void )
#line 216
{
...
# 72 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x40cc4030){
#line 72
  switch (arg_0x40cc4030) {
#line 72
    case 0U:
#line 72
      DiscoC__Timer0__fired();
#line 72
      break;
#line 72
    case 1U:
#line 72
      DiscoC__Timer1__fired();
#line 72
      break;
#line 72
    case 2U:
#line 72
      testmasterC__Timer0__fired();
#line 72
      break;
#line 72
    case 3U:
#line 72
      DiscoC__Timer2_retransmit__fired();
#line 72
      break;
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x40cc4030);
#line 72
      break;
#line 72
    }
...
#line 151
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x40b41908, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__send(arg_0x40b41908, addr, msg, len);
#line 69
...
# 23 "/opt/tinyos-2.1.1/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__dataLinkLength(uart_id_t arg_0x40817b10, message_t *msg, uint8_t upperLen){
#line 23
  unsigned char __nesc_result;
#line 23

#line 23
  switch (arg_0x40817b10) {
#line 23
...
#line 23
    default:
#line 23
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__dataLinkLength(arg_0x40817b10, msg, upperLen);
#line 23
      break;
#line 23
    }
...
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__offset(uart_id_t arg_0x40817b10){
#line 15
  unsigned char __nesc_result;
#line 15
...
#line 15
    default:
#line 15
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__offset(arg_0x40817b10);
#line 15
      break;
#line 15
    }
...
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x40b44e48, message_t * msg, error_t error){
#line 89
  switch (arg_0x40b44e48) {
#line 89
    case 0U:
...
#line 89
    default:
#line 89
      /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x40b44e48, msg, error);
#line 89
      break;
#line 89
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__granted(uint8_t arg_0x408b4478){
#line 92
  switch (arg_0x408b4478) {
#line 92
...
#line 92
    default:
#line 92
      /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__default__granted(arg_0x408b4478);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__Resource__granted(uint8_t arg_0x40af2e78){
#line 92
  switch (arg_0x40af2e78) {
#line 92
...
#line 92
    default:
#line 92
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__Resource__default__granted(arg_0x40af2e78);
#line 92
      break;
#line 92
    }
...
# 49 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__configure(uint8_t arg_0x40aeecf8){
#line 49
  switch (arg_0x40aeecf8) {
#line 49
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__configure(arg_0x40aeecf8);
#line 49
      break;
#line 49
    }
...
# 39 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/Msp430UartConfigure.nc"
inline static msp430_uart_union_config_t */*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__getConfig(uint8_t arg_0x408b1500){
#line 39
  union __nesc_unnamed4288 *__nesc_result;
#line 39

#line 39
  switch (arg_0x408b1500) {
#line 39
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 39
...
#line 39
    default:
#line 39
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__default__getConfig(arg_0x408b1500);
#line 39
      break;
#line 39
    }
...
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__sendDone(am_id_t arg_0x40763ae8, message_t * msg, error_t error){
#line 99
  /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x40763ae8, msg, error);
#line 99
}
#line 99
...
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__sendDone(uart_id_t arg_0x40817010, message_t * msg, error_t error){
#line 89
  switch (arg_0x40817010) {
#line 89
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 89
...
#line 89
    default:
#line 89
      /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__default__sendDone(arg_0x40817010, msg, error);
#line 89
      break;
#line 89
    }
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__receive(am_id_t arg_0x4076e548, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__default__receive(arg_0x4076e548, msg, payload, len);
#line 67
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__receive(uart_id_t arg_0x4081a918, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x4081a918) {
#line 67
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 67
...
#line 67
    default:
#line 67
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__default__receive(arg_0x4081a918, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 31 "/opt/tinyos-2.1.1/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__upperLength(uart_id_t arg_0x40817b10, message_t *msg, uint8_t dataLinkLen){
#line 31
  unsigned char __nesc_result;
#line 31
...
#line 31
    default:
#line 31
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__upperLength(arg_0x40817b10, msg, dataLinkLen);
#line 31
      break;
#line 31
    }
...
# 55 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__unconfigure(uint8_t arg_0x40aeecf8){
#line 55
  switch (arg_0x40aeecf8) {
#line 55
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 55
    default:
#line 55
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__unconfigure(arg_0x40aeecf8);
#line 55
      break;
#line 55
    }
...
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__release(uint8_t arg_0x408b2a48){
#line 110
  unsigned char __nesc_result;
#line 110

#line 110
  switch (arg_0x408b2a48) {
#line 110
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 110
...
#line 110
    default:
#line 110
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__release(arg_0x408b2a48);
#line 110
      break;
#line 110
    }
...
# 118 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static bool /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__isOwner(uint8_t arg_0x408b2a48){
#line 118
  unsigned char __nesc_result;
#line 118
...
#line 118
    default:
#line 118
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__isOwner(arg_0x408b2a48);
#line 118
      break;
#line 118
    }
...
# 62 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void testmasterC__Timer0__startOneShot(uint32_t dt){
#line 62
...
# 59 "/opt/tinyos-2.1.1/tos/interfaces/Notify.nc"
inline static error_t testmasterC__Notify__enable(void ){
#line 59
  unsigned char __nesc_result;
#line 59
...
inline static void testmasterC__Leds__led1Off(void ){
#line 66
...
#line 105
{
  ...
  testmasterC__Leds__led1Off();

  testmasterC__Disco__setNodeClass(TOS_NODE_ID);


  if (testmasterC__Notify__enable() == SUCCESS) 
    {
      testmasterC__Leds__led1On();
    }
  srand(TOS_NODE_ID);
  testmasterC__Timer0__startOneShot(15000);
}

# 49 "/opt/tinyos-2.1.1/tos/interfaces/Boot.nc"
inline static void PrintfP__Boot__booted(void ){
#line 49
  testmasterC__Boot__booted();
#line 49
}
#line 49
...
# 51 "/opt/tinyos-2.1.1/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__immediateRequested(uint8_t arg_0x40aef948){
#line 51
    /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__immediateRequested(arg_0x40aef948);
#line 51
}
#line 51
# 90 "/opt/tinyos-2.1.1/tos/system/ArbiterP.nc"
...
# 87 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__immediateRequest(uint8_t arg_0x408b2a48){
#line 87
  unsigned char __nesc_result;
#line 87
...
#line 87
    default:
#line 87
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__immediateRequest(arg_0x408b2a48);
#line 87
      break;
#line 87
    }
...
# 79 "/opt/tinyos-2.1.1/tos/interfaces/UartStream.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receivedByte(uint8_t arg_0x408b3680, uint8_t byte){
#line 79
  switch (arg_0x408b3680) {
#line 79
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 79
...
#line 79
    default:
#line 79
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receivedByte(arg_0x408b3680, byte);
#line 79
      break;
#line 79
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receiveDone(uint8_t arg_0x408b3680, uint8_t * buf, uint16_t len, error_t error){
#line 99
  switch (arg_0x408b3680) {
#line 99
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 99
    default:
#line 99
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receiveDone(arg_0x408b3680, buf, len, error);
#line 99
      break;
#line 99
    }
...
# 54 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__rxDone(uint8_t arg_0x40aa7f08, uint8_t data){
#line 54
  switch (arg_0x40aa7f08) {
#line 54
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
#line 54
...
#line 54
    default:
#line 54
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__rxDone(arg_0x40aa7f08, data);
#line 54
      break;
#line 54
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__sendDone(uint8_t arg_0x408b3680, uint8_t * buf, uint16_t len, error_t error){
#line 57
  switch (arg_0x408b3680) {
#line 57
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 57
    default:
#line 57
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__sendDone(arg_0x408b3680, buf, len, error);
#line 57
      break;
#line 57
    }
...
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__txDone(uint8_t arg_0x40aa7f08){
#line 49
  switch (arg_0x40aa7f08) {
#line 49
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__txDone(arg_0x40aa7f08);
#line 49
      break;
#line 49
    }
...
# 54 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__rxDone(uint8_t arg_0x40aa7f08, uint8_t data){
#line 54
  switch (arg_0x40aa7f08) {
#line 54
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 54
    default:
#line 54
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__rxDone(arg_0x40aa7f08, data);
#line 54
      break;
#line 54
    }
...
# 39 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430I2CInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__I2CInterrupts__fired(uint8_t arg_0x40ac9ed0){
#line 39
    /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__I2CInterrupts__default__fired(arg_0x40ac9ed0);
#line 39
}
#line 39
...
# 49 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__txDone(uint8_t arg_0x40aa7f08){
#line 49
  switch (arg_0x40aa7f08) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__txDone(arg_0x40aa7f08);
#line 49
      break;
#line 49
    }
...
# 28 "/opt/tinyos-2.1.1/tos/chips/msp430/timer/Msp430TimerEvent.nc"
static void /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__fired(uint8_t arg_0x4065d4b0){
#line 28
  switch (arg_0x4065d4b0) {
#line 28
    case 0:
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__default__fired(arg_0x4065d4b0);
#line 28
      break;
#line 28
    }
...
#line 64
# 36 "/home/tinyos/WSN/src/src/testmasterC.nc"
static void testmasterC__Notify__notify(button_state_t value)
{
  if (value == BUTTON_PRESSED && testmasterC__ButtonPressCounter == 0) 
    {
      testmasterC__Disco__setBeaconMode(TRUE);
      testmasterC__Disco__setNodeClass(TOS_NODE_ID);
      testmasterC__Disco__setDutyCycleIndex(testmasterC__MprimeIDX[0], rand());
  ...
  testmasterC__ButtonPressCounter++;
}

# 57 "/home/tinyos/WSN/src/src/DiscoC.nc"
static float DiscoC__Disco__setDutyCycleIndex(uint16_t dutycycleIdx, uint32_t shift)
#line 57
{
  if (dutycycleIdx >= 150) {
...
#line 60
  DiscoC__prime1 = lutPrime1[dutycycleIdx];
  DiscoC__prime2 = lutPrime2[dutycycleIdx];
  DiscoC__DC = (float )lutDC[dutycycleIdx] / 10000.0f;
  DiscoC__counter = shift;
  DiscoC__Timer0__startPeriodic(TSLOTms);
  return 0;
}
...
# 67 "/home/tinyos/WSN/src/src/Disco.h"
static uint8_t calcCheckSumMsg(DiscoMsg *this)
{
  uint8_t i;
  uint8_t checksum = 0;
...
# 221 "/home/tinyos/WSN/src/src/DiscoC.nc"
static void DiscoC__transmit_done(void )
{
  DiscoC__Timer2_retransmit__stop();
  DiscoC__PacketSize = 0;
  DiscoC__retry_counter = 0;
  if (DiscoC__eop) 
    {
      DiscoC__Timer1__startOneShot(T_TIMEOUT_ms);
    }
}
...
# 55 "/home/tinyos/WSN/src/src/Disco.h"
static void createDiscoMsg(DiscoMsg *this, uint16_t nodeid, uint16_t counter, uint16_t timeslot, uint16_t prime1, uint16_t prime2, uint8_t type, uint8_t payload_len)
{
  __nesc_hton_uint16(this->nodeid.data, nodeid);
  __nesc_hton_uint16(this->counter.data, counter);
  __nesc_hton_uint16(this->timeslot.data, timeslot);
  __nesc_hton_uint16(this->prime1.data, prime1);
  __nesc_hton_uint16(this->prime2.data, prime2);
  __nesc_hton_uint8(this->type.data, type);
  __nesc_hton_uint8(this->payload_len.data, payload_len);
  __nesc_hton_uint8(this->checksum.data, calcCheckSumMsg(this));
}

# 232 "/home/tinyos/WSN/src/src/DiscoC.nc"
static void DiscoC__transmit(void )
{
  ...
  if (!DiscoC__busy) 
    {
      if (DiscoC__AMSend__send(AM_BROADCAST_ADDR, &DiscoC__pkt, DiscoC__PacketSize) == SUCCESS) {
          DiscoC__busy = TRUE;
        }
    }
  ...
  if (DiscoC__retry_counter != 0) 
    {
      DiscoC__Timer2_retransmit__startOneShot(T_TIMEOUT_ms);
      DiscoC__retry_counter--;
    }
  else {
#line 249
    if (DiscoC__eop) 
...
# 256 "/home/tinyos/WSN/src/src/DiscoC.nc"
static void DiscoC__transmitBeacon(void )
{
  DiscoMsg *dmpkt;

#line 259
  if (!DiscoC__busy && DiscoC__beaconEn) 
    {

      dmpkt = (DiscoMsg *)DiscoC__Packet__getPayload(&DiscoC__pkt, sizeof(DiscoMsg ));
      createDiscoMsg(dmpkt, DiscoC__ID, DiscoC__counter, TSLOTms, DiscoC__prime1, DiscoC__prime2, T_BEACON, 0);
